...
knitr::opts_chunk$set(
  ...
  fig.width = 6.5, fig.height = 4.5, dpi = 110
)
set.seed(1)
...
```{r, echo=FALSE, message=FALSE, eval=requireNamespace("DiagrammeR", quietly = TRUE)}
DiagrammeR::grViz("workflow.dot", width = "100%", height = 640)
```
...
plot_correlated_fitness(
  ...
  show_optimum = TRUE,  # Mark the highest predicted fitness
  show_groups = TRUE,   # Mark group means and local peaks when the surface has a group
...
**Purpose:** Compares the individual-level fitness surface with the population-level adaptive landscape: their optima, the distance between them, summary statistics and the correlation between the two surfaces.
